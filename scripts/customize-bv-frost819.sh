...
/enum class PlaySpeedItem\(val code: Int, private val strRes: Int, val speed: Float\) \{/ {
    print $0
    print "    x5(19, R.string.play_speed_x5, 5f),"
    print "    x4_75(18, R.string.play_speed_x4_75, 4.75f),"
    print "    x4_5(17, R.string.play_speed_x4_5, 4.5f),"
    print "    x4_25(16, R.string.play_speed_x4_25, 4.25f),"
    print "    x4(15, R.string.play_speed_x4, 4f),"
    print "    x3_75(14, R.string.play_speed_x3_75, 3.75f),"
    print "    x3_5(13, R.string.play_speed_x3_5, 3.5f),"
    print "    x3_25(12, R.string.play_speed_x3_25, 3.25f),"
    print "    x3(11, R.string.play_speed_x3, 3f),"
    print "    x2_75(10, R.string.play_speed_x2_75, 2.75f),"
    print "    x2_5(9, R.string.play_speed_x2_5, 2.5f),"
    print "    x2_25(8, R.string.play_speed_x2_25, 2.25f),"
    print "    x2(7, R.string.play_speed_x2, 2f),"
    print "    x1_75(6, R.string.play_speed_x1_75, 1.75f),"
    print "    x1_5(5, R.string.play_speed_x1_5, 1.5f),"
    print "    x1_25(4, R.string.play_speed_x1_25, 1.25f),"
    print "    x1(3, R.string.play_speed_x1, 1f),"
    print "    x0_75(2, R.string.play_speed_x0_75, 0.75f),"
    print "    x0_5(1, R.string.play_speed_x0_5, 0.5f),"
